...
dis_salinity <-discretize(sharkattackoutput$Salinity_Mod,"equalwidth", 3)
...
dis_turbidity <-discretize(sharkattackoutput$Turbidity_Mod,"equalwidth", 3)
...
dis_temperature <-discretize(sharkattackoutput$Temperature_Mod,"equalwidth", 3)
...
dis_precipitation <-discretize(sharkattackoutput$Precipitation_Value_Mod,"equalwidth", 3)
...
dis_pressure <-discretize(sharkattackoutput$Station_Pressure_Mod,"equalwidth", 3)
...
dis_windspeed <-discretize(sharkattackoutput$Wind_Speed_Mod,"equalwidth", 3)
...
sharkattackoutput$Precipitation_Value_Mod[sharkattackoutput$Precipitation_Value_Mod == "T"] <-  0

sharkattackoutput$Precipitation_Value_Mod <- as.numeric(sharkattackoutput$Precipitation_Value_Mod )
sharkattackoutput $prep_moving_average <- SMA(sharkattackoutput$Precipitation_Value_Mod , n = 5)
...
write.csv(sharkattackoutput, "alldatesfinal.csv")
